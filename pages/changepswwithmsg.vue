    ...
    <v-stepper :value="step" vertical>
      ...
      <v-stepper-content step="1">
        ...
        <v-text-field
            ...
            required
          ></v-text-field>
        <v-btn @click="getCode" :disabled="(msg.fetching || timer) && true" flat>{{buttonText}}</v-btn>
        <v-btn color="primary" @click="nextStep" :disabled="(!msg.phoneInfo || !code) && true">下一步</v-btn>
        </v-form>
      </v-stepper-content>
      ...
      <v-stepper-content step="2">
        <v-form v-model="valid" ref="form" lazy-validation>
          ...
          <v-text-field
            ...
            required
          ></v-text-field>
          <v-btn color="primary" :loading="change.fetching" @click="changeWithPhone">提交</v-btn>
...
export default {
  ...
  computed: {
    ...mapState('changepasswordwithmsg', ['step', 'msg', 'change', 'message'])
  },
